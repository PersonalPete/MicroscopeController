classdef SimpleMscopeGUI < handle
    ...
    properties (SetAccess = private)
        ...
        TIMER_AFFIG_PERIOD = 0.1; % update the autofocus figure at 10 Hz when it's open
        ...
        % Acquisition start/stop handles
        StartVideoH;
        StartCaptH;
        StopCaptH;
        ...
        COLOR_FPOS_BGD = [0.62 0.71 0.80];
        COLOR_FPOS_TEXT = [0.2 0.2 0.2];
    ...
    methods (Access = public)
        ...
        function obj = SimpleMscopeGUI
            ...
            % builds the laser/card controller etc.
            ...
            fprintf(' ...Success\nConnecting to autofocus camera...');
            obj.AfCamCon = AfCamController;
            obj.AfCamCon.setRoi(obj.AfRoi); % set the region of interest to the default
            ...
            try % in a try-catch so we always disconnect from camera
                ...
                obj.LeftRightDisplayH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.80, 0.45, 0.0666, 0.04],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.UpDownDisplayH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.8666, 0.45, 0.0666, 0.04],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.LeftPosH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'Units','normalized',....
                    'Position',[0.80 0.525, 0.0666, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.RightPosH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','normalized',....
                    'Position',[0.80 0.575, 0.0666, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.UpPosH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','normalized',....
                    'Position',[0.8666 0.575, 0.0666, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.DownPosH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','normalized',....
                    'Position',[0.8666 0.525, 0.0666, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.FocusUpH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','normalized',....
                    'Position',[0.9333 0.575, 0.0666, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.FocusDownH = uicontrol('Parent',obj.MainFigH,...
                    ...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','normalized',....
                    'Position',[0.9333 0.525, 0.0666, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.LeftFastPosH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@obj.leftFastMove,...
                    'Style','pushbutton',...
                    'BackgroundColor',obj.COLOR_FPOS_BGD,...
                    'Units','normalized',....
                    'Position',[0.80 0.50, 0.0666, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                    'ForegroundColor',obj.COLOR_FPOS_TEXT,...
                    'String','',...'LEFT',...
                    'Visible','on');
                
                obj.RightFastPosH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@obj.rightFastMove,...
                    'Style','pushbutton',...
                    'BackgroundColor',obj.COLOR_FPOS_BGD,...
                    'Units','normalized',....
                    'Position',[0.80 0.625, 0.0666, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.UpFastPosH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@obj.upFastMove,...
                    'Style','pushbutton',...
                    'BackgroundColor',obj.COLOR_FPOS_BGD,...
                    'Units','normalized',....
                    'Position',[0.8666 0.625, 0.0666, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.DownFastPosH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@obj.downFastMove,...
                    'Style','pushbutton',...
                    'BackgroundColor',obj.COLOR_FPOS_BGD,...
                    'Units','normalized',....
                    'Position',[0.8666 0.50, 0.0666, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.FocusUpFastH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@obj.focusUpFastMove,...
                    'Style','pushbutton',...
                    'BackgroundColor',obj.COLOR_FPOS_BGD,...
                    'Units','normalized',....
                    'Position',[0.9333 0.625, 0.0666, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.FocusDownFastH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@obj.focusDownFastMove,...
                    'Style','pushbutton',...
                    'BackgroundColor',obj.COLOR_FPOS_BGD,...
                    'Units','normalized',....
                    'Position',[0.9333 0.50, 0.0666, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.TirfDisplayH = uicontrol('Parent',obj.MainFigH,...
                    'Style','text',...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.88, 0.425, 0.04, 0.0225],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.TirfRightH = uicontrol('Parent',obj.MainFigH,...
                    'Style','pushbutton',...
                    'Callback',@obj.tirfRightMove,...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','Normalized',...
                    'Position',[0.92, 0.425, 0.04, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.TirfLeftH = uicontrol('Parent',obj.MainFigH,...
                    'Style','pushbutton',...
                    'Callback',@obj.tirfLeftMove,...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','Normalized',...
                    'Position',[0.84, 0.425, 0.04, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.TirfFastRightH = uicontrol('Parent',obj.MainFigH,...
                    'Style','pushbutton',...
                    'Callback',@obj.tirfFastRightMove,...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','Normalized',...
                    'Position',[0.96, 0.425, 0.04, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                obj.TirfFastLeftH = uicontrol('Parent',obj.MainFigH,...
                    'Style','pushbutton',...
                    'Callback',@obj.tirfFastLeftMove,...
                    'BackgroundColor',obj.COLOR_POS_BGD,...
                    'Units','Normalized',...
                    'Position',[0.80, 0.425, 0.04, 0.025],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.6,...
                    'FontWeight','normal',...
                ...
                %% AUTOFOCUS CONTROLS
                obj.AfFigOpenH = uicontrol('Parent',obj.MainFigH,...
                    'Callback',@(~,~)obj.openAfFig,...
                    'Style','pushbutton',...
                ...
                obj.AfFigH = figure('CloseRequestFcn',@(~,~) obj.closeAfFig,...
                    ...
                    'ColorMap',gray(obj.MAX_DATA),...
                    'DockControls','off',...
                    'Name','Autofocus Settings',...
                    'Units','Normalized',...
                    'OuterPosition',obj.AfFigPos,...
                    'Pointer','arrow',...
                    'Renderer','OpenGL',...
                    'Toolbar','none',...
                    'MenuBar','none',...
                ...
                obj.AfLineH = line('Parent',obj.AfAxisH,'LineStyle','-',...
                    'Marker','none','Color','r',...
                ...
                obj.AfRoiH = uicontrol('Parent',obj.AfFigH,...
                    'Callback',@obj.setAfRoi,...
                    'Style','edit',...
                    'BackgroundColor',obj.COLOR_INPUT_BGD,...
                    'Units','Normalized',...
                    'Position',[0.11, 0.30, 0.78, 0.10],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.5,...
                    'FontWeight','normal',...
                    'ForegroundColor',obj.COLOR_INPUT_TEXT,...
                    'String',num2str(obj.AfRoi),...
                    'Visible','on');
                
                obj.AfRoiStringH = uicontrol('Parent',obj.AfFigH,...
                    'Style','text',...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.05, 0.40, 0.90, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.8,...
                    'FontWeight','normal',...
                    'ForegroundColor',obj.COLOR_INFO_TEXT,...
                    'String','Autofocus region of interest:',...
                    'Visible','on');
                
                obj.AfCentPosH = uicontrol('Parent',obj.AfFigH,...
                    'Style','text',...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.1, 0.225, 0.80, 0.05],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.5,...
                    'FontWeight','normal',...
                ...
                obj.AfExposureStringH = uicontrol('Parent',obj.AfFigH,...
                    'Style','text',...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.20, 0.11, 0.30, 0.07],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                ...
                obj.AfExposureH = uicontrol('Parent',obj.AfFigH,...
                    'Callback',@obj.setAfExposure,...
                    'Style','edit',...
                    'BackgroundColor',obj.COLOR_INPUT_BGD,...
                    'Units','Normalized',...
                    'Position',[0.55, 0.11, 0.30, 0.10],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.5,...
                    'FontWeight','normal',...
                    'ForegroundColor',obj.COLOR_INPUT_TEXT,...
                    'String',sprintf('%.2f ms',obj.AfExposure),...
                    'Visible','on');
                
                obj.AfFrameRateStringH = uicontrol('Parent',obj.AfFigH,...
                    'Style','text',...
                    'BackgroundColor',obj.COLOR_INFO_BGD,...
                    'Units','Normalized',...
                    'Position',[0.20, 0.01, 0.30, 0.07],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INFO,...
                    'FontSize',0.4,...
                    'FontWeight','normal',...
                    'ForegroundColor',obj.COLOR_INFO_TEXT,...
                    'String','AF frame rate:',...
                    'Visible','on');
                
                obj.AfFrameRateH = uicontrol('Parent',obj.AfFigH,...
                    'Callback',@obj.setAfFrameRate,...
                    'Style','edit',...
                    'BackgroundColor',obj.COLOR_INPUT_BGD,...
                    'Units','Normalized',...
                    'Position',[0.55, 0.01, 0.30, 0.10],...
                    'FontUnits','Normalized',...
                    'FontName',obj.FONT_INPUT,...
                    'FontSize',0.5,...
                    'FontWeight','normal',...
                    'ForegroundColor',obj.COLOR_INPUT_TEXT,...
                    'String',sprintf('%.1f Hz',obj.AfFrameRate),...
                    'Visible','on');
                
                obj.TimerAfFig = timer('Period',obj.TIMER_AFFIG_PERIOD,...
                    'BusyMode','drop',...
                    'ExecutionMode','fixedSpacing',...
                    'TimerFcn',@(~,~)obj.updateAfFig);
                
                % make sure the frame time and exposure displays are
                % accurate
            ...
            % store the intial position of the axes and update the displays
            obj.UpDownSetPos = obj.StageCon.getPosition(obj.UpDownStage);
            obj.LeftRightSetPos = obj.StageCon.getPosition(obj.LeftRightStage);
            obj.FocusSetPos = obj.StageCon.getPosition(obj.FocusStage);
            
            set(obj.UpDownDisplayH,'string',sprintf('%.5f',obj.UpDownSetPos));
            set(obj.LeftRightDisplayH,'string',sprintf('%.5f',obj.LeftRightSetPos));
            set(obj.FocusDisplayH,'string',sprintf('%.5f',obj.FocusSetPos));
    ...
    methods (Access = public) % should be private, but for debugging make them public
        ...
        function updatePos(obj)
            % includes the TIRF stage position
            ...
            % only do one stage per timer run, and do a different stage
            % each time
            switch mod(runCount,4)
                ...
                case 3
                    set(obj.TirfDisplayH,'string',sprintf('%.2f',obj.StageCon.getPosition(obj.TirfStage)));
            end
        end
        ...
        %% AUTOFOCUS SETTINGS
        function openAfFig(obj,~,~)
            % makes the autofocus figure visible and starts the timer that
            % updates it
            try
                start(obj.TimerAfFig);
            catch
            end
            set(obj.AfFigH,'Position',obj.AfFigPos,'Visible','on');
        end % openAfFig
        
        function closeAfFig(obj,~,~)
            % stops the autofocus figure timer and hides the figure
            try
                stop(obj.TimerAfFig);
            catch
            end
            set(obj.AfFigH,'Visible','off');
        end % closeAfFig
        
        function setAfRoi(obj,src,~)
            % defines the region of the AF camera chip to use for autofocus
        ...
        function updateAfFig(obj)
            % updater for the autofocus figure that grabs a frame from the
            % AF camera and plots it
            set(obj.AfImageH,'CData',obj.AfCamCon.getLastFrame');
            set(obj.AfLineH,...
                'XData',[obj.AfRoi(1), obj.AfRoi(2), obj.AfRoi(2), obj.AfRoi(1), obj.AfRoi(1)],...
                'YData',[obj.AfRoi(3), obj.AfRoi(3), obj.AfRoi(4), obj.AfRoi(4), obj.AfRoi(3)]);
