    ...
    methods (Access = public) % should be private, but for debugging make them public
        ...
        function updateAfFig(obj)
            ...
            set(obj.AfLineH,...
                'XData',[obj.AfRoi(1), obj.AfRoi(2), obj.AfRoi(2), obj.AfRoi(1), obj.AfRoi(1)],...
                'YData',[obj.AfRoi(3), obj.AfRoi(3), obj.AfRoi(4), obj.AfRoi(4), obj.AfRoi(3)]);
            set(obj.AfCentPosH,'String',sprintf('Centroid: %.2f px',obj.AfCamCon.centroidLastFrame));               
        end % updateAfFig
        %% ADVANCED SETTINGS
